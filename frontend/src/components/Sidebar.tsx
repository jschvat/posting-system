    ...
    <SidebarContent>
      ...
      <Section>
        ...
        <NavList>
          ...
          <NavItem>
            <NavLink to="/marketplace/offers/received" $isActive={isActive('/marketplace/offers/received')}>
              <IconPlaceholder>📥</IconPlaceholder>
              Received Offers
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink to="/marketplace/offers/sent" $isActive={isActive('/marketplace/offers/sent')}>
              <IconPlaceholder>📤</IconPlaceholder>
              Sent Offers
            </NavLink>
          </NavItem>
